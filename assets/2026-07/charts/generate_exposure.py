...
mkt_data = np.array([
    [ 0.40, -0.35, -0.45, -0.01, -0.61],
    [ 0.77, -0.46, -0.55,  0.35, -0.47],
    [-0.45, -0.49, -0.52, -0.61,  0.15],
    [-0.02,  0.54,  0.66, -0.10,  0.02],
    [ 0.03,  0.04,  0.25, -0.44,  0.28],
    [-0.30,  0.08,  0.12,  0.39,  0.27],
    [-0.41, -0.02, -0.04,  0.23,  0.43],
    [-0.38,  0.76,  0.43,  1.16,  0.02],
    [ 0.23, -0.06, -0.10, -0.04, -0.60],
    [-0.12,  0.08,  0.16, -0.96, -0.02],
])
...
tilt_factors = ["Momentum", "Volatility", "Growth", "Value", "Liquidity"]
tilt_values  = [1.83, 1.77, 1.57, -0.19, -1.16]
